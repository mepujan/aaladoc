# Generated by Django 3.2.5 on 2021-12-18 11:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(default='morang', max_length=100)),
                ('profile_pic', models.ImageField(null=True, upload_to='media')),
                ('blood_group', models.CharField(blank=True, choices=[('A+', 'A+'), ('B+', 'B+'), ('B-', 'B-'), ('A-', 'A-'), ('AB+', 'AB+'), ('AB-', 'AB-'), ('O+', 'O+'), ('O-', 'O-')], max_length=200)),
                ...
                ('search_keyword', models.CharField(blank=True, max_length=3)),
